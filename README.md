...
-   **Directional Accuracy**: The HMM model achieved a directional accuracy of **90.91%** in predicting price movements over a window of 22 trading days.
...
-   **Directional Accuracy**: The ARIMA model achieved a directional accuracy of **90.91%** in predicting price movements over a window of 22 trading days.
